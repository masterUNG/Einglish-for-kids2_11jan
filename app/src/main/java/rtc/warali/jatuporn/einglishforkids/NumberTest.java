...
public class NumberTest extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageView4_nb:
                intChoose = 1;
                break;
            case R.id.imageView5_nb:
                intChoose = 2;
                break;
            case R.id.imageView6_nb:
                intChoose = 3;
                break;
        }   // switch
        ...
        if (intChoose == trueAnswerInts[timesAnInt]) {
            ...
            Toast.makeText(NumberTest.this, "ลองใหม่ คุณตอบผิด คะ", Toast.LENGTH_SHORT).show();
    ...
    private void soundTrueFalse(int soundInt) {
        MediaPlayer mediaPlayer = MediaPlayer.create(NumberTest.this, soundInt);
        mediaPlayer.start();
    ...
    private void myAlert() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(NumberTest.this);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(NumberTest.this, Shop.class));
            }
        });
        builder.show();
